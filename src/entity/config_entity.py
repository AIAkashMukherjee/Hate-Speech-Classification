...
class DataIngestionConfig:
    def __init__(self):
        ...
        self.DATA_ARTIFACTS_DIR = self.DATA_INGESTION_ARTIFACTS_DIR
        self.NEW_DATA_ARTIFACTS_DIR = os.path.join(self.DATA_INGESTION_ARTIFACTS_DIR, DATA_INGESTION_RAW_DATA_DIR)
        self.ZIP_FILE_DIR = self.DATA_INGESTION_ARTIFACTS_DIR
...
class DatatransformationCOnfig:
    def __init__(self):
        self.DataTransformation_Artifact_Dir=os.path.join(os.getcwd(), ARTIFACTS_DIR, DATA_TRANSFORMATION_ARTIFACTS_DIR)
        self.Transformed_File_path=os.path.join(self.DataTransformation_Artifact_Dir,TRANSFORMED_FILE_NAME)
        self.Axis=AXIS
